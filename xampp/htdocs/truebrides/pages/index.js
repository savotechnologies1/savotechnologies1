      ...
      <div className="mainLayout" style={{ maxWidth: width }}>
        {
          <>
            ...
            <Row className="headerRowMain">
              <Col
                className="indexHeaderCol"
                xs={{ offset: 0, span: 24 }}
                md={{ offset: 1, span: 22 }}
                lg={{ offset: 2, span: 20 }}
                xl={{ offset: 4, span: 16 }}
            ...
            <Row className="signupFooterRowBgImg">
              <Col span={24}>
                <SignupFooter onFindMatch={() => setPopOverIndex(0)} />
              </Col>
            </Row>
            <Row className="rowBGColor" justify="center" align="middle">
              <Col span={24}>
                <SingleBlog />
              </Col>
            </Row>
